...
cairo_pdf("FigureS5N_v1.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5N_v2.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5N_v3.pdf", width = 5, height = 4, family = "Arial")
...
write.table(output, file = "FigureS5N_Stats_Ref_mCherry.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "FigureS5N_Stats_Ref_mCherry-ALC1.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
