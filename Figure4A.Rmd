...
```{r}
library(gdata)
dataset <- read.delim("raw_data/Figure4A.txt", stringsAsFactors = FALSE)
...
pdf("Figure4A_v1.pdf", width = 5, height = 4)
...
cairo_pdf("Figure4A_v2.pdf", width = 5, height = 4)
...
cairo_pdf("Figure4A_v3.pdf", width = 5, height = 4)
...
write.table(output, file = "Figure4A_Stats_Ref_WT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure4A_Stats_Ref_ALC1.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
