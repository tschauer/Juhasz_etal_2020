...
cairo_pdf("Figure4A_v1.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("Figure4A_v2.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("Figure4A_v3.pdf", width = 5, height = 4, family = "Arial")
...
write.table(output, file = "Figure4A_Stats_Ref_WT_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure4A_Stats_Ref_ALC1_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure4A_Stats_Ref_WT_Olaparib.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
