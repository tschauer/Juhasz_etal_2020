...
cairo_pdf("Figure5D_v1.pdf", width = 6, height = 4, family = "Arial")
...
cairo_pdf("Figure5D_v2.pdf", width = 6, height = 4, family = "Arial")
...
cairo_pdf("Figure5D_v3.pdf", width = 6, height = 4, family = "Arial")
...
write.table(output, file = "Figure5D_Stats_Ref_WT_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5D_Stats_Ref_ALC1_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5D_Stats_Ref_WT_Olaparib.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
