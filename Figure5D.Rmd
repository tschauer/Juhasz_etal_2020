...
```{r}
library(gdata)
dataset <- read.delim("raw_data/Figure5D.txt", stringsAsFactors = FALSE)
...
pdf("Figure5D_v1.pdf", width = 6, height = 4)
...
cairo_pdf("Figure5D_v2.pdf", width = 6, height = 4)
...
cairo_pdf("Figure5D_v3.pdf", width = 6, height = 4)
...
write.table(output, file = "Figure5D_Stats_Ref_WT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5D_Stats_Ref_ALC1.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
