...
cairo_pdf("FigureS5H_v1.pdf", width = 6, height = 4, family = "Arial")
...
cairo_pdf("FigureS5H_v2.pdf", width = 6, height = 4, family = "Arial")
...
cairo_pdf("FigureS5H_v3.pdf", width = 6, height = 4, family = "Arial")
...
write.table(output, file = "FigureS5H_Stats_Ref_WT_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "FigureS5H_Stats_Ref_ALC1_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "FigureS5H_Stats_Ref_WT_Olaparib.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "FigureS5H_Stats_Ref_ALC1KO_Olaparib.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
