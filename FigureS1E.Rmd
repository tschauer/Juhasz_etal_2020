...
```{r}
dataset <- read.delim("raw_data/FigureS1E.txt", stringsAsFactors = FALSE)
...
cairo_pdf("FigureS1E_v1.pdf", width = 14, height = 4, family = "Arial")
...
cairo_pdf("FigureS1E_v2.pdf", width = 6, height = 4, family = "Arial")
...
write.table(output, file = "FigureS1E_Stats_Ref_ALC1KO.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
