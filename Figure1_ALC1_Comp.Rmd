...
```{r}
dataset <- read.delim("raw_data/Figure1_ALC1_Comp.txt", stringsAsFactors = FALSE)
...
cairo_pdf("Figure1_ALC1_Comp_v1.pdf", width = 14, height = 4, family = "Arial")
...
cairo_pdf("Figure1_ALC1_Comp_v2.pdf", width = 6, height = 4, family = "Arial")
...
write.table(output, file = "Figure1_ALC1_Comp_Stats_Ref_WT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure1_ALC1_Comp_Stats_Ref_ALC1KO.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure1_ALC1_Comp_Stats_Ref_ALC1KO+ALC1WT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
