...
```{r}
library(gdata)
dataset <- read.delim("raw_data/FigureS5O.txt", stringsAsFactors = FALSE)
...
cairo_pdf("FigureS5O_v1.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5O_v2.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5O_v3.pdf", width = 5, height = 4, family = "Arial")
...
write.table(output, file = "FigureS5O_Stats_Ref_mCherry.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "FigureS5O_Stats_Ref_mCherry-ALC1.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
