...
write.table(output, file = "Figure5F_Stats_Ref_h_d11.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5F_Stats_Ref_d11_d11.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
