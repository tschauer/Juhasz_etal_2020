...
```{r}
dataset <- read.delim("raw_data/Figure5F.txt", stringsAsFactors = FALSE)
...
pdf("Figure5F.pdf", width = 5, height = 4)
...
write.table(output, file = "Figure5F_Stats_Ref_WT_siCtrl.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5F_Stats_Ref_WT_siBRCA1.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
