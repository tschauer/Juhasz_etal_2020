...
```{r}
library(gdata)
dataset <- read.delim("raw_data/Figure5C.txt", stringsAsFactors = FALSE)
...
cairo_pdf("Figure5C_v1.pdf", width = 6, height = 4, family = "Arial")
...
cairo_pdf("Figure5C_v2.pdf", width = 6, height = 4, family = "Arial")
...
cairo_pdf("Figure5C_v3.pdf", width = 6, height = 4, family = "Arial")
...
write.table(output, file = "Figure5C_Stats_Ref_WT_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5C_Stats_Ref_ALC1_NT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5C_Stats_Ref_WT_Olaparib.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure5C_Stats_Ref_ALC1KO_Olaparib.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
