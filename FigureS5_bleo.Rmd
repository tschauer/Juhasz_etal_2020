...
```{r}
dataset <- read.delim("raw_data/SFigure5_bleo.txt", stringsAsFactors = FALSE)
...
pdf("FigureS5_bleo.pdf", width = 5, height = 4)
...
write.table(output, file = "FigureS5_bleo_Stats.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
