...
cairo_pdf("FigureS5F_v1.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5F_v2.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5F_v3.pdf", width = 5, height = 4, family = "Arial")
...
write.table(output, file = "FigureS5F_Stats_Ref_siCtrl.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "FigureS5F_Stats_Ref_siALC1.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
