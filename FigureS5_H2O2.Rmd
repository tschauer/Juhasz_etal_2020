...
```{r}
dataset <- read.delim("raw_data/SFigure5_h2o2.txt", stringsAsFactors = FALSE)
...
pdf("FigureS5_H2O2.pdf", width = 5, height = 4)
...
write.table(output, file = "FigureS5_H2O2_Stats.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
