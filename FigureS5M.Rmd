...
cairo_pdf("FigureS5M_v1.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5M_v2.pdf", width = 5, height = 4, family = "Arial")
...
cairo_pdf("FigureS5M_v3.pdf", width = 5, height = 4, family = "Arial")
...
write.table(output, file = "FigureS5M_Stats_Ref_mCherry.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "FigureS5M_Stats_Ref_mCherry-ALC1.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
