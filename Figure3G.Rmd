...
```{r}
library(gdata)
dataset <- read.delim("raw_data/Figure3G.txt", stringsAsFactors = FALSE)
...
cairo_pdf("Figure3G_v1.pdf", width = 7, height = 4, family = "Arial")
...
cairo_pdf("Figure3G_v2.pdf", width = 7, height = 4, family = "Arial")
...
cairo_pdf("Figure3G_v3.pdf", width = 7, height = 4, family = "Arial")
...
write.table(output, file = "Figure3G_Stats_Ref_WT.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
...
write.table(output, file = "Figure3G_Stats_Ref_ALC1KO.txt", quote = F, sep = "\t", row.names = T, col.names = NA)
```
